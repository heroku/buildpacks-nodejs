...
- This buildpack now prunes pnpm dev dependencies at the end of its build to reduce the final image size. ([#1128](https://github.com/heroku/buildpacks-nodejs/pull/1128))

...
#[test]
#[ignore = "integration test"]
fn pnpm_test_native_modules_are_recompiled_even_on_cache_restore() {
...
#[test]
#[ignore = "integration test"]
fn pnpm_test_skip_build_scripts_from_buildplan() {
...
#[test]
#[ignore = "integration test"]
fn pnpm_test_default_web_process_registration_is_skipped_if_procfile_exists() {

...
Heroku's Cloud Native Buildpack for [@heroku/sf-fx-runtime-nodejs](https://github.com/forcedotcom/sf-fx-runtime-nodejs) and [Salesforce Functions](https://developer.salesforce.com/docs/platform/functions/overview).
...
```
pack build example-fn-image --buildpack heroku/nodejs-engine --buildpack heroku/nodejs-npm --buildpack heroku/nodejs-function-invoker --path /some/example-fn
```

## Additional Info

For development, dependencies, contribution, license and other info, please refer to the [root README.md](../../README.md).

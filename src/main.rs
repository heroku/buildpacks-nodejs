...
impl libcnb::Buildpack for NodeJsBuildpack {
    ...
    fn build(
        ...
        // // To prevent .pyc files from being generated by node-gyp
        // // ref: https://github.com/heroku/buildpacks-python/blob/a812275a1142a3ad104ac381f2aac61d7e005183/src/layers/python.rs#L213-L249
        // utils::build_env::set_default_env_var(
        //     &context,
        //     &mut env,
        //     "SOURCE_DATE_EPOCH",

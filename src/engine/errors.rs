use crate::common::error_handling;
use crate::common::error_handling::error_message_builder::SetIssuesUrl;
use crate::common::error_handling::ErrorType::{Internal, UserFacing};
use crate::common::error_handling::{
    file_value, ErrorMessage, ErrorMessageBuilder, SuggestRetryBuild, SuggestSubmitIssue,
};
...
fn error_message() -> ErrorMessageBuilder<SetIssuesUrl> {
    error_handling::error_message().issues_url(ISSUES_URL.to_string())
}
...
fn on_buildpack_error(error: NodeJsEngineBuildpackError) -> ErrorMessage {
    match error {
        ...
        NodeJsEngineBuildpackError::Application(e) => error_message()
